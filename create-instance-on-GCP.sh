...
INSTANCE_NAME=kafka-instance-4
...
gcloud beta compute --project=$PROJECT_ID instances create $INSTANCE_NAME \
    ...
    --create-disk="mode=rw,size=100,type=projects/sandbox-236618/zones/europe-west3-c/diskTypes/pd-ssd,name=kafka-standalone-datadisk-1,description=for kafka and zookeeper data,device-name=kafka-standalone-datadisk-1"
